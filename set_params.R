...
variance_in_Xs_explained_by_U=0.1 # scalar 
variance_in_Y_explained_by_U=0.25 # scalar
variance_in_Y_explained_by_Xs=0.5 # scalar
### Set of SNPs Causal for Exposure(s) 
number_of_causal_SNPs=100 # scalar
variance_in_Xs_explained_by_all_causal_SNPs=0.15 # scalar
number_of_weak_causal_SNPs=5 # scalar (weak for all exposures if there's more than 1)
variance_in_Xs_explained_by_weak_causal_SNPs=0.001 # scalar
