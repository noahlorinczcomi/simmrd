...
if(!require('mvnfast')) install.packages('mvnfast',repos='http://cran.us.r-project.org')
library(mvnfast);library(ggplot2)
################################################################################
...
Xs_variance_explained_by_U=0.15 # scalar
...
Xs_variance_explained_by_g=0.05 # scalar
...
fix_Fstatistic_at=5 # average across exposures, not conditional F-statistics
