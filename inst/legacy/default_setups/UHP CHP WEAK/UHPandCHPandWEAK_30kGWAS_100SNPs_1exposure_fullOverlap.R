...
summary_params=list(
  ...
  number_of_UHP_causal_SNPs=10, # number of UHP causal SNPs
  number_of_CHP_causal_SNPs=10, # number of CHP causal SNPs
  ...
  simtype='weak', # performs IV selection based on P-value
  fix_Fstatistic_at=5, # (ignore if simtype=='winners') fix the mean F-statistic for the exposures
